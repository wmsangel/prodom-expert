  ...
  function domexpert_affiliate_offers(): array {
    return [
      ...
      [
        ...
        'icon'  => '🛒',
        'tags'  => ['vstroennaya-tehnika-dlya-kuhni', 'obogrevatel-dlya-kvartiry-vybor', 'elektrokotel-dlya-doma-vybor', 'kak-vybrat-konditsioner', 'vytyazhka-dlya-kuhni-vybor', 'podklyuchenie-varochnoy-paneli-i-duhovki', 'podklyuchenie-posudomoechnoy-mashiny',
      ...
      // Woodgrand — завод террасной доски из ДПК/МПК (декинг, фасады, ограждения).
      // Продукт уличный/полу-уличный → на нашем сайте бьётся в узкую, но точную нишу:
      // пол балкона и лоджии (декинг — популярный финиш). CPA (/g/, Per Sale): доставка
      // по РФ, аппрув 99%, EPC 21614 ₽, высокий интент «обустраиваю балкон». Ставим ПЕРЕД
      // Петровичем/МЕГАСТРОЙ, чтобы на балконных страницах выигрывал слот у широких сетей.
      [
        'id'    => 'woodgrand',
        'title' => 'Woodgrand',
        'desc'  => 'Террасная доска из ДПК для пола балкона и лоджии: не боится влаги, не требует ухода. Бесплатные образцы.',
